...
- Samuel: I have mainly participated in the detail page of Ej or the corresponding page, ensuring that the elements of the main and secondary entity appear. I have also been in charge of the error and confirmation pages and their entire implementation on the server. And also with the editing and deletion of elements.
